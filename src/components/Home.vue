...
<template>
  <div id="home">
    ...
    <div v-if="authState && authState.isAuthenticated">
      ...
      <p>Once you have downloaded and started the example resource server, you can visit the 
        <a href="/messages">My Messages</a>
         page to see the authentication process in action.</p>

          <a href="/messages">ACX</a>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    async setup () {
      console.log(this.authState.isAuthenticated, '----isAuthenticated----')
